  ...
  return (
    <div className="OurProcess-main-container p-18">
      <div className="OurProcess-second-container flex flex-col lg:flex-row"> 
        {/* Left Image Section */}
        <div className="OurProcess-left-container flex-shrink-0" style={{ height:'1600', width: '800px' }}>
          <img
        ...
        <div className="OurProcess-right-container bg-[#002f46] justify-center text-1xl text-white p-32 flex-1">
          ...
          <p className="mt-6 text-1xl font-semibold">Discover how we build innovative software solutions and high-quality products tailored to your needs.</p>

          <div className="firstDiv mt-6">
            <h2 className="cursor-pointer rounded-2xl text-black text-3xl py-8 font-semibold transition-all bg-[#fff] pl-12 mt-16" onClick={() => toggleContent(1)}> 1. Discovery Stage</h2>
            {openStage === 1 && (
          ...
          <div className="firstDiv mt-6">
            <h2 className="cursor-pointer rounded-2xl text-black text-3xl py-8 font-semibold transition-all bg-[#fff] pl-12 mt-12" onClick={() => toggleContent(2)}>2. Development Stage </h2>
            {openStage === 2 && (
              <div className="our-process-content open mt-4">
                <p className="text-lg">
          ...
          <div className="firstDiv mt-6">
            <h2 className="cursor-pointer rounded-2xl text-black text-3xl py-8 font-semibold transition-all bg-[#fff] pl-12 mt-12" onClick={() => toggleContent(3)}>3.Support and Development </h2>
            {openStage === 3 && (
              <div className="mt-4">
                <p className="text-lg">
