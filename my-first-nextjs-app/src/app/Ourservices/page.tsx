      ...
      case 'App Development':
        return {
          ...
          description:
            'Build robust and scalable websites with modern frameworks and a user-centered approach to elevate your online presence.',
          image:
            'https://img.freepik.com/premium-photo/young-woman-using-source-code-develop-new-online-app-working-with-html-script-terminal-window-program-database-software-it-manager-planning-artificial-intelligence-network_1035542-260.jpg?ga=GA1.1.1906549316.1744116662&semt=ais_country_boost&w=740',
        };
      case 'Graphic Designing':
        return {
          ...
          description:
            'Build robust and scalable websites with modern frameworks and a user-centered approach to elevate your online presence.',
          image:
            'https://img.freepik.com/free-photo/logo-designer-working-computer-desktop_23-2149142153.jpg?ga=GA1.1.1906549316.1744116662&semt=ais_country_boost&w=740',
        };
      case 'UI/UX Designing':
        return {
          ...
          description:
            'Build robust and scalable websites with modern frameworks and a user-centered approach to elevate your online presence.',
          image:
            'https://img.freepik.com/free-photo/woman-with-editor-occupation-wearing-headphones_482257-10564.jpg?ga=GA1.1.1906549316.1744116662&semt=ais_country_boost&w=740',
        };
      case 'SEO Marketing':
        return {
          title: 'SEO Marketing',
          description:
            'Build robust and scalable websites with modern frameworks and a user-centered approach to elevate your online presence.',
          image:
            'https://img.freepik.com/free-photo/employee-working-marketing-setting_23-2151871171.jpg?t=st=1744202854~exp=1744206454~hmac=34a64ab3319b718279113929e151b8833709bf52774836eb51b0877b076cb5f8&w=900',
        };
      case 'Website Development':
        return {
          ...
          description:
            'Build robust and scalable websites with modern frameworks and a user-centered approach to elevate your online presence.',
          image:
            'https://img.freepik.com/free-photo/html-css-collage-concept_23-2150061955.jpg?t=st=1744208365~exp=1744211965~hmac=4277bb5686a8a1ffe60aec2fa5334626e80348c2b4a000f553504cea5968766c&w=900',
        };
      case 'SaaS Based Website Development':
        return {
          ...
          description:
            'Build robust and scalable websites with modern frameworks and a user-centered approach to elevate your online presence.',
          image:
            'https://img.freepik.com/premium-photo/ar-brainstorming-mobile-app-interface-design-modern-office_1105604-39210.jpg?ga=GA1.1.1906549316.1744116662&semt=ais_country_boost&w=740',
        };
      default:
        return {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                  ...
                  <ul>
                    {items.map((item) => (
                      <li
                        ...
                        className={`cursor-pointer text-lg xl:text-2xl font-bold py-4 px-6 rounded-lg transition-all duration-300 ${
                          activeItem === item
          ...
          <div className="relative w-full rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-center text-white px-10 py-12 space-y-6 bg-opacity-50">
              ...
              <p className="text-lg font-medium max-w-3xl text-justify">
                {description}
              </p>
